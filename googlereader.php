...
class GoogleReader {
	...
	function getJin115Feed() {
		...
		$feedUrl = "http://www.google.com/reader/atom/feed/http://mrss.dokoda.jp/a/http/jin115.com/index.rdf?n=1000&xt=user/-/state/com.google/read";
		$options = array(
			'http' => array(
				'method' => 'GET',
				'header' => implode("\r\n", $headers),
